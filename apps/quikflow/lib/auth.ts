...
/**
 * QuikFlow auth configuration.
 *
 * When QUIKIT_URL is set, QuikFlow authenticates via QuikIT's OAuth2 flow
 * (the platform IdP model). When unset, falls back to the direct
 * CredentialsProvider for local dev. Mirrors apps/quikscale/lib/auth.ts.
 */
