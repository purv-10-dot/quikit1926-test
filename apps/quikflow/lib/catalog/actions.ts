...
export const ACTION_CATALOG: CatalogAction[] = [
  ...
  { id: "notify.email.send", label: "Send an email", category: "Notify", doesWhat: "Send email", requiredInputs: ["to", "subject", "body"], optionalInputs: ["cc[]", "bcc[]", "template_id", "attachments[]"], permission: "none", output: "{ delivery_id }" },
  ...
  // ── KPI ────────────────────────────────────────────────────────────────
  { id: "kpi.create", label: "Create a KPI", category: "KPI", doesWhat: "Create a KPI", requiredInputs: ["name", "owner_id", "target", "cadence", "unit", "type"], optionalInputs: ["linked_to_opsp", "is_ai_suggested", "source_type", "source_id"], permission: "kpi.write", output: "Kpi" },
  { id: "kpi.update", label: "Update KPI fields", category: "KPI", doesWhat: "Update KPI fields", requiredInputs: ["kpi_id", "fields{}"], optionalInputs: ["note"], permission: "kpi.write", output: "Kpi" },
  { id: "kpi.value.enter", label: "Enter a weekly KPI value", category: "KPI", doesWhat: "Enter weekly value", requiredInputs: ["kpi_id", "week_number", "value"], optionalInputs: ["note"], permission: "kpi.write", output: "KpiWeekEntry" },
  ...
  { id: "opsp.finalize", label: "Finalize an OPSP", category: "OPSP", doesWhat: "Finalize OPSP (locks all)", requiredInputs: ["opsp_id"], optionalInputs: [], permission: "opsp.finalize", output: "Opsp" },
  { id: "opsp.review.mark", label: "Mark an OPSP reviewed", category: "OPSP", doesWhat: "Mark Reviewed", requiredInputs: ["opsp_id"], optionalInputs: [], permission: "opsp.review", output: "Opsp" },
