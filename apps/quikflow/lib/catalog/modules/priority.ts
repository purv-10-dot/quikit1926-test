...
export const PRIORITY_MODULE: ModuleDef = {
  ...
  events: [
    ...
    { id: "priority.overdue", label: "A priority passes its due date", firesWhen: "Past due, still open", payloadFields: ["dueDate"] },
    { id: "priority.owner.assigned", label: "An owner is set on a priority", firesWhen: "An owner is assigned", payloadFields: ["owner"] },
