      ...
      <div className={clsx("flex items-center gap-3", className)}>
        ...
        <div className="flex flex-col gap-1">
          <button type="button" onClick={() => inputRef.current?.click()} disabled={disabled || uploadMut.isPending}
            className="inline-flex items-center gap-1 px-2.5 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded text-xs font-medium shadow-sm disabled:opacity-60">
  ...
  return (
    <div className={clsx("space-y-1", className)}>
      ...
      {value ? (
        ...
        <button type="button" onClick={() => inputRef.current?.click()} disabled={disabled || uploadMut.isPending}
          className="w-full flex items-center justify-center gap-2 px-3 py-2.5 border-2 border-dashed border-gray-300 rounded-lg text-sm text-gray-500 hover:border-blue-400 hover:bg-blue-50/40 hover:text-blue-600 transition disabled:opacity-60">
