      ...
      <div>
        ...
        <div className="space-y-2">
          <label className="flex items-center gap-2 text-sm text-gray-700">
            <input type="radio" checked={!form.isRecurring} onChange={() => setForm({ ...form, isRecurring: false })} className="text-[#3b82f6]" />
            One-time deduction
          </label>
          <label className="flex items-center gap-2 text-sm text-gray-700">
            <input type="radio" checked={form.isRecurring} onChange={() => setForm({ ...form, isRecurring: true })} className="text-[#3b82f6]" />
