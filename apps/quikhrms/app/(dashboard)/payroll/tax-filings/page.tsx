...
const TABS: { id: Tab; label: string; icon: React.ReactNode }[] = [
  { id: "form16",   label: "Tax computation", icon: <FileText size={14} /> },
  { id: "form12bb", label: "Form 12BB",    icon: <Receipt size={14} /> },
];
...
export default function TaxFilingsHub() {
  ...
  return (
    <div className="w-full px-6 py-6">
      <h1 className="font-serif-display text-3xl md:text-4xl font-bold text-gray-900 mb-1">Tax Filings</h1>
      <p className="text-sm text-gray-500 mb-5">Statutory tax documents and challans in one place.</p>
        ...
        {TABS.map((t) => (
          <button
            ...
            className={clsx(
              ...
              tab === t.id ? "bg-white text-[#16243A] shadow-sm" : "text-gray-600 hover:text-gray-900",
            )}
          >
            {t.icon} {t.label}
          </button>
