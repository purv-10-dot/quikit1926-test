...
export default function PreferencesPage() {
  return (
    <div className="max-w-3xl space-y-4">
      <div>
        <h1 className="text-base font-semibold text-gray-900 dark:text-white">Preferences</h1>
      ...
      <section className="surface-card p-4">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="flex-1">
            <h2 className="text-[13px] font-semibold text-gray-900 dark:text-white">Appearance</h2>
