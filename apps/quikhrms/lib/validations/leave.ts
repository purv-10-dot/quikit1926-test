...
export const createLeaveTypeSchema = z.object({
  ...
  maxCarryForward: z.number().int().optional(),
  isEncashable: z.boolean().default(false),
  maxEncashment: z.number().int().optional(),
  ...
  minConsecutiveDays: z.number().int().optional(),
  ...
  documentationAfterDays: z.number().int().optional(),
  isNegativeBalanceAllowed: z.boolean().default(false),
  maxNegativeBalance: z.number().int().optional(),
