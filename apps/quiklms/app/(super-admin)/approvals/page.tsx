          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div className="space-y-3">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-tight">
                Quality <span className="text-indigo-200">Assurance</span>
              </h1>
              <p className="text-indigo-100/80 text-base sm:text-lg font-medium max-w-2xl">
                Review and moderate content submissions from tenant organizations across the platform.
              </p>
            </div>
            <button
              onClick={loadItems}
              className="group self-start lg:self-center bg-white/10 hover:bg-white/20 backdrop-blur-xl text-white px-8 py-4 rounded-2xl font-bold inline-flex items-center gap-3 transition-all duration-300 border border-white/20 hover:border-white/40 shadow-lg active:scale-95"
            >
