          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 text-center lg:text-left">
            <div className="space-y-3">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-tight">
                Audit <span className="text-indigo-200">& Analytics</span>
              </h1>
              <p className="text-indigo-100/80 text-base sm:text-lg font-medium max-w-2xl">
                Platform-wide storage intelligence, security audit trails, and tenant resource optimization.
              </p>
            </div>
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
              <button
                onClick={() => setShowTemplateEditor(true)}
                className="bg-white/10 hover:bg-white/20 backdrop-blur-xl text-white px-8 py-4 rounded-2xl font-bold inline-flex items-center gap-3 transition-all duration-300 border border-white/20 hover:border-white/40 shadow-lg active:scale-95"
              >
              ...
              <button
                onClick={loadData}
                className="bg-white text-indigo-600 hover:bg-indigo-50 px-8 py-4 rounded-2xl font-black inline-flex items-center gap-3 transition-all duration-300 shadow-xl active:scale-95"
              >
