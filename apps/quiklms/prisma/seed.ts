...
async function upsertUser(
  id: string, email: string, role: UserRole, tenantId: string | null,
  first: string, last: string, hash: string, extra: Record<string, unknown> = {},
) {
  await prisma.user.upsert({
    where: { id },
    create: { id, email, password: hash, firstName: first, lastName: last, role, tenantId, isActive: true, mustChangePassword: false, ...extra },
    update: { email, password: hash, role, tenantId, firstName: first, lastName: last, ...extra },
  });
}
...
async function main() {
  ...
  await prisma.group.upsert({ where: { id: GRP_ENG   }, create: { id: GRP_ENG,   tenantId: CORP_ID, name: 'Engineering Team', description: 'All engineering employees', createdBy: U.CORP_ADMIN }, update: {} });
  await prisma.group.upsert({ where: { id: GRP_SALES }, create: { id: GRP_SALES, tenantId: CORP_ID, name: 'Sales Team',        description: 'Sales & business development', createdBy: U.CORP_ADMIN }, update: {} });
  ...
  await prisma.course.upsert({ where: { id: CRS.SAFETY  }, create: { id: CRS.SAFETY,  tenantId: CORP_ID,   title: 'Workplace Safety & Compliance', category: 'Safety',     description: 'Essential safety procedures for all employees.',               authorId: U.CORP_ADMIN, status: 'Published' }, update: { status: 'Published' } });
  await prisma.course.upsert({ where: { id: CRS.LEADER  }, create: { id: CRS.LEADER,  tenantId: CORP_ID,   title: 'Leadership Essentials',         category: 'Leadership', description: 'Core leadership skills for managers and aspiring leaders.',    authorId: U.CORP_ADMIN, status: 'Published' }, update: { status: 'Published' } });
  await prisma.course.upsert({ where: { id: CRS.GDPR    }, create: { id: CRS.GDPR,    tenantId: CORP_ID,   title: 'GDPR & Data Privacy',           category: 'Compliance', description: 'GDPR requirements and data protection best practices.',       authorId: U.CORP_ADMIN, status: 'Published' }, update: { status: 'Published' } });
  await prisma.course.upsert({ where: { id: CRS.MATH    }, create: { id: CRS.MATH,    tenantId: SCHOOL_ID, title: 'Mathematics Grade 5',           category: 'Math',       description: 'Grade 5 mathematics: fractions, geometry, and algebra.',     authorId: U.SCH_ADMIN,  status: 'Published' }, update: { status: 'Published' } });
  await prisma.course.upsert({ where: { id: CRS.SCIENCE }, create: { id: CRS.SCIENCE, tenantId: SCHOOL_ID, title: 'Science Grade 5',               category: 'Science',    description: 'Grade 5 science: plants, animals, matter, and basic physics.', authorId: U.SCH_ADMIN, status: 'Published' }, update: { status: 'Published' } });

  // ── Modules ───────────────────────────────────────────────────────────────
  const mods = [
    { id: 'mod-s1', courseId: CRS.SAFETY,  title: 'Introduction to Safety',   orderIndex: 1, tenantId: CORP_ID   },
    { id: 'mod-s2', courseId: CRS.SAFETY,  title: 'Emergency Procedures',     orderIndex: 2, tenantId: CORP_ID   },
    { id: 'mod-l1', courseId: CRS.LEADER,  title: 'Communication Skills',     orderIndex: 1, tenantId: CORP_ID   },
    { id: 'mod-l2', courseId: CRS.LEADER,  title: 'Team Management',          orderIndex: 2, tenantId: CORP_ID   },
    { id: 'mod-g1', courseId: CRS.GDPR,    title: 'GDPR Fundamentals',        orderIndex: 1, tenantId: CORP_ID   },
    { id: 'mod-g2', courseId: CRS.GDPR,    title: 'Data Subject Rights',      orderIndex: 2, tenantId: CORP_ID   },
    { id: 'mod-m1', courseId: CRS.MATH,    title: 'Fractions & Decimals',     orderIndex: 1, tenantId: SCHOOL_ID },
    { id: 'mod-m2', courseId: CRS.MATH,    title: 'Geometry Basics',          orderIndex: 2, tenantId: SCHOOL_ID },
    { id: 'mod-c1', courseId: CRS.SCIENCE, title: 'Living World',             orderIndex: 1, tenantId: SCHOOL_ID },
    { id: 'mod-c2', courseId: CRS.SCIENCE, title: 'Matter & Materials',       orderIndex: 2, tenantId: SCHOOL_ID },
  ];
  for (const m of mods) {
  ...
  // ── Course Assignments ────────────────────────────────────────────────────
  const assignments = [
    { id: 'ca-001', tenantId: CORP_ID, courseId: CRS.SAFETY, targetType: 'USER',  targetId: U.CORP_L1,  isMandatory: true,  assignedBy: U.CORP_ADMIN, dueDate: new Date('2026-07-31') },
    { id: 'ca-002', tenantId: CORP_ID, courseId: CRS.SAFETY, targetType: 'GROUP', targetId: GRP_ENG,    isMandatory: true,  assignedBy: U.CORP_ADMIN, dueDate: new Date('2026-07-31') },
    { id: 'ca-003', tenantId: CORP_ID, courseId: CRS.LEADER, targetType: 'USER',  targetId: U.CORP_MGR, isMandatory: false, assignedBy: U.CORP_ADMIN },
    { id: 'ca-004', tenantId: CORP_ID, courseId: CRS.GDPR,   targetType: 'GROUP', targetId: GRP_SALES,  isMandatory: true,  assignedBy: U.CORP_SUB,   dueDate: new Date('2026-08-15') },
    { id: 'ca-005', tenantId: CORP_ID, courseId: CRS.GDPR,   targetType: 'USER',  targetId: U.CORP_L2,  isMandatory: true,  assignedBy: U.CORP_ADMIN, dueDate: new Date('2026-08-15') },
    { id: 'ca-006', tenantId: CORP_ID, courseId: CRS.SAFETY, targetType: 'USER',  targetId: U.CORP_L2,  isMandatory: true,  assignedBy: U.CORP_ADMIN, dueDate: new Date('2026-07-31') },
    { id: 'ca-007', tenantId: CORP_ID, courseId: CRS.LEADER, targetType: 'GROUP', targetId: GRP_ENG,    isMandatory: false, assignedBy: U.CORP_ADMIN },
  ];
  ...
  // ── Progress ──────────────────────────────────────────────────────────────
  const progressRecs = [
    { id: 'pg-001', tenantId: CORP_ID,   learnerId: U.CORP_L1, courseId: CRS.SAFETY, status: 'Completed',  completionPercentage: 100, isPassed: true,  completedAt: new Date('2026-06-01'), startedAt: new Date('2026-05-01') },
    { id: 'pg-002', tenantId: CORP_ID,   learnerId: U.CORP_L1, courseId: CRS.LEADER, status: 'InProgress', completionPercentage: 60,  startedAt: new Date('2026-06-05') },
    { id: 'pg-003', tenantId: CORP_ID,   learnerId: U.CORP_L2, courseId: CRS.SAFETY, status: 'InProgress', completionPercentage: 40,  startedAt: new Date('2026-06-10') },
    { id: 'pg-004', tenantId: CORP_ID,   learnerId: U.CORP_L2, courseId: CRS.GDPR,   status: 'NotStarted', completionPercentage: 0,   startedAt: new Date('2026-06-15') },
    { id: 'pg-005', tenantId: CORP_ID,   learnerId: U.CORP_L3, courseId: CRS.SAFETY, status: 'Completed',  completionPercentage: 100, isPassed: true,  completedAt: new Date('2026-06-10'), startedAt: new Date('2026-05-15') },
    { id: 'pg-006', tenantId: CORP_ID,   learnerId: U.CORP_L3, courseId: CRS.GDPR,   status: 'InProgress', completionPercentage: 75,  startedAt: new Date('2026-06-12') },
    { id: 'pg-007', tenantId: CORP_ID,   learnerId: U.CORP_MGR,courseId: CRS.LEADER, status: 'Completed',  completionPercentage: 100, isPassed: true,  completedAt: new Date('2026-06-18'), startedAt: new Date('2026-06-01') },
    { id: 'pg-008', tenantId: SCHOOL_ID, learnerId: U.SCH_S1,  courseId: CRS.MATH,   status: 'Completed',  completionPercentage: 100, isPassed: true,  completedAt: new Date('2026-05-20'), startedAt: new Date('2026-04-01') },
    { id: 'pg-009', tenantId: SCHOOL_ID, learnerId: U.SCH_S2,  courseId: CRS.MATH,   status: 'InProgress', completionPercentage: 50,  startedAt: new Date('2026-04-15') },
    { id: 'pg-010', tenantId: SCHOOL_ID, learnerId: U.SCH_S3,  courseId: CRS.MATH,   status: 'InProgress', completionPercentage: 30,  startedAt: new Date('2026-05-01') },
    { id: 'pg-011', tenantId: SCHOOL_ID, learnerId: U.SCH_S1,  courseId: CRS.SCIENCE,status: 'InProgress', completionPercentage: 65,  startedAt: new Date('2026-05-01') },
    { id: 'pg-012', tenantId: SCHOOL_ID, learnerId: U.SCH_S2,  courseId: CRS.SCIENCE,status: 'NotStarted', completionPercentage: 0,   startedAt: new Date('2026-06-01') },
  ];
  ...
  await prisma.certificate.upsert({
    ...
    create: {
      id: CERT_TPL_CORP, tenantId: CORP_ID, name: 'Acme Course Completion Certificate',
  ...
  await prisma.certificate.upsert({
    ...
    create: {
      id: CERT_TPL_SCHOOL, tenantId: SCHOOL_ID, name: 'Bright School Academic Achievement',
  ...
  await prisma.certificateIssued.upsert({
    where: { id: 'ci-001' },
    create: { id: 'ci-001', tenantId: CORP_ID,   learnerId: U.CORP_L1,  courseId: CRS.SAFETY,  certificateTemplateId: CERT_TPL_CORP,   courseName: 'Workplace Safety & Compliance', learnerName: 'Leo Learner',   certificateId: 'QS-CERT-20260601-001', verificationUrl: 'https://quikskill.test/verify/QS-CERT-20260601-001', issuedAt: new Date('2026-06-01'), score: 92, passingScore: 70, passed: true, pdfUrl: '', qrCodeUrl: '' },
    update: {},
  });
  await prisma.certificateIssued.upsert({
    where: { id: 'ci-002' },
    create: { id: 'ci-002', tenantId: CORP_ID,   learnerId: U.CORP_L3,  courseId: CRS.SAFETY,  certificateTemplateId: CERT_TPL_CORP,   courseName: 'Workplace Safety & Compliance', learnerName: 'Jake Engineer', certificateId: 'QS-CERT-20260610-002', verificationUrl: 'https://quikskill.test/verify/QS-CERT-20260610-002', issuedAt: new Date('2026-06-10'), score: 88, passingScore: 70, passed: true, pdfUrl: '', qrCodeUrl: '' },
    update: {},
  });
  await prisma.certificateIssued.upsert({
    where: { id: 'ci-003' },
    create: { id: 'ci-003', tenantId: CORP_ID,   learnerId: U.CORP_MGR, courseId: CRS.LEADER,  certificateTemplateId: CERT_TPL_CORP,   courseName: 'Leadership Essentials',         learnerName: 'Maya Manager',  certificateId: 'QS-CERT-20260618-003', verificationUrl: 'https://quikskill.test/verify/QS-CERT-20260618-003', issuedAt: new Date('2026-06-18'), score: 95, passingScore: 70, passed: true, pdfUrl: '', qrCodeUrl: '' },
    update: {},
  });
  await prisma.certificateIssued.upsert({
    where: { id: 'ci-004' },
    create: { id: 'ci-004', tenantId: SCHOOL_ID, learnerId: U.SCH_S1,   courseId: CRS.MATH,    certificateTemplateId: CERT_TPL_SCHOOL, courseName: 'Mathematics Grade 5',           learnerName: 'Sara Student',  certificateId: 'QS-CERT-20260520-004', verificationUrl: 'https://quikskill.test/verify/QS-CERT-20260520-004', issuedAt: new Date('2026-05-20'), score: 95, passingScore: 60, passed: true, pdfUrl: '', qrCodeUrl: '' },
    update: {},
  });
  ...
  await prisma.batch.upsert({
    where: { id: BATCH_MATH },
    create: {
      id: BATCH_MATH, tenantId: SCHOOL_ID, name: 'Math 5A', grade: '5', section: 'A', subject: 'Math',
  ...
  await prisma.batch.upsert({
    where: { id: BATCH_SCI },
    create: {
      id: BATCH_SCI, tenantId: SCHOOL_ID, name: 'Science 5A', grade: '5', section: 'A', subject: 'Science',
  ...
  // ── Scheduled Classes ─────────────────────────────────────────────────────
  const classes = [
    { id: 'sc-m1', tenantId: SCHOOL_ID, batchId: BATCH_MATH, teacherId: U.SCH_T1, title: 'Math Class 1 – Fractions',    startTime: new Date('2026-06-02T09:00:00Z'), endTime: new Date('2026-06-02T10:00:00Z'), status: 'completed' },
    { id: 'sc-m2', tenantId: SCHOOL_ID, batchId: BATCH_MATH, teacherId: U.SCH_T1, title: 'Math Class 2 – Decimals',     startTime: new Date('2026-06-04T09:00:00Z'), endTime: new Date('2026-06-04T10:00:00Z'), status: 'completed' },
    { id: 'sc-m3', tenantId: SCHOOL_ID, batchId: BATCH_MATH, teacherId: U.SCH_T1, title: 'Math Class 3 – Geometry',     startTime: new Date('2026-06-09T09:00:00Z'), endTime: new Date('2026-06-09T10:00:00Z'), status: 'completed' },
    { id: 'sc-m4', tenantId: SCHOOL_ID, batchId: BATCH_MATH, teacherId: U.SCH_T1, title: 'Math Class 4 – Angles',       startTime: new Date('2026-06-25T09:00:00Z'), endTime: new Date('2026-06-25T10:00:00Z'), status: 'scheduled' },
    { id: 'sc-s1', tenantId: SCHOOL_ID, batchId: BATCH_SCI,  teacherId: U.SCH_T2, title: 'Science Class 1 – Plants',    startTime: new Date('2026-06-03T10:00:00Z'), endTime: new Date('2026-06-03T11:00:00Z'), status: 'completed' },
    { id: 'sc-s2', tenantId: SCHOOL_ID, batchId: BATCH_SCI,  teacherId: U.SCH_T2, title: 'Science Class 2 – Animals',   startTime: new Date('2026-06-10T10:00:00Z'), endTime: new Date('2026-06-10T11:00:00Z'), status: 'completed' },
    { id: 'sc-s3', tenantId: SCHOOL_ID, batchId: BATCH_SCI,  teacherId: U.SCH_T2, title: 'Science Class 3 – Matter',    startTime: new Date('2026-06-26T10:00:00Z'), endTime: new Date('2026-06-26T11:00:00Z'), status: 'scheduled' },
  ];
  ...
  const attRecs = [
    // Math Class 1
    { id: 'att-001', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m1', batchId: BATCH_MATH, studentId: U.SCH_S1, markedBy: U.SCH_T1, status: 'present', classDate: new Date('2026-06-02') },
    { id: 'att-002', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m1', batchId: BATCH_MATH, studentId: U.SCH_S2, markedBy: U.SCH_T1, status: 'present', classDate: new Date('2026-06-02') },
    { id: 'att-003', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m1', batchId: BATCH_MATH, studentId: U.SCH_S3, markedBy: U.SCH_T1, status: 'absent',  classDate: new Date('2026-06-02') },
    // Math Class 2
    { id: 'att-004', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m2', batchId: BATCH_MATH, studentId: U.SCH_S1, markedBy: U.SCH_T1, status: 'present', classDate: new Date('2026-06-04') },
    { id: 'att-005', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m2', batchId: BATCH_MATH, studentId: U.SCH_S2, markedBy: U.SCH_T1, status: 'late',    classDate: new Date('2026-06-04') },
    { id: 'att-006', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m2', batchId: BATCH_MATH, studentId: U.SCH_S3, markedBy: U.SCH_T1, status: 'present', classDate: new Date('2026-06-04') },
    // Math Class 3
    { id: 'att-007', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m3', batchId: BATCH_MATH, studentId: U.SCH_S1, markedBy: U.SCH_T1, status: 'present', classDate: new Date('2026-06-09') },
    { id: 'att-008', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m3', batchId: BATCH_MATH, studentId: U.SCH_S2, markedBy: U.SCH_T1, status: 'present', classDate: new Date('2026-06-09') },
    { id: 'att-009', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m3', batchId: BATCH_MATH, studentId: U.SCH_S3, markedBy: U.SCH_T1, status: 'present', classDate: new Date('2026-06-09') },
    // Science Class 1
    { id: 'att-010', tenantId: SCHOOL_ID, scheduledClassId: 'sc-s1', batchId: BATCH_SCI,  studentId: U.SCH_S1, markedBy: U.SCH_T2, status: 'present', classDate: new Date('2026-06-03') },
    { id: 'att-011', tenantId: SCHOOL_ID, scheduledClassId: 'sc-s1', batchId: BATCH_SCI,  studentId: U.SCH_S2, markedBy: U.SCH_T2, status: 'absent',  classDate: new Date('2026-06-03') },
    // Science Class 2
    { id: 'att-012', tenantId: SCHOOL_ID, scheduledClassId: 'sc-s2', batchId: BATCH_SCI,  studentId: U.SCH_S1, markedBy: U.SCH_T2, status: 'present', classDate: new Date('2026-06-10') },
    { id: 'att-013', tenantId: SCHOOL_ID, scheduledClassId: 'sc-s2', batchId: BATCH_SCI,  studentId: U.SCH_S2, markedBy: U.SCH_T2, status: 'present', classDate: new Date('2026-06-10') },
  ];
  ...
  await prisma.homework.upsert({
    where: { id: HW1 },
    create: {
      id: HW1, tenantId: SCHOOL_ID, batchId: BATCH_MATH, teacherId: U.SCH_T1,
  ...
  await prisma.homework.upsert({
    where: { id: HW2 },
    create: {
      id: HW2, tenantId: SCHOOL_ID, batchId: BATCH_SCI, teacherId: U.SCH_T2,
  ...
  await prisma.homework.upsert({
    where: { id: HW3 },
    create: {
      id: HW3, tenantId: SCHOOL_ID, batchId: BATCH_MATH, teacherId: U.SCH_T1,
  ...
  for (const sub of [
    { id: 'hws-001', tenantId: SCHOOL_ID, homeworkId: HW1, studentId: U.SCH_S1, submittedAt: new Date('2026-06-18'), isLate: false, status: 'graded',    score: 18, feedback: 'Excellent work! Keep it up.', gradedBy: U.SCH_T1, gradedAt: new Date('2026-06-19'), finalScore: 18 },
    { id: 'hws-002', tenantId: SCHOOL_ID, homeworkId: HW1, studentId: U.SCH_S2, submittedAt: new Date('2026-06-19'), isLate: false, status: 'submitted' },
    { id: 'hws-003', tenantId: SCHOOL_ID, homeworkId: HW1, studentId: U.SCH_S3, submittedAt: new Date('2026-06-21'), isLate: true,  status: 'submitted' },
    { id: 'hws-004', tenantId: SCHOOL_ID, homeworkId: HW2, studentId: U.SCH_S1, submittedAt: new Date('2026-06-21'), isLate: false, status: 'graded',    score: 14, feedback: 'Great diagram, label the roots clearly.', gradedBy: U.SCH_T2, gradedAt: new Date('2026-06-22'), finalScore: 14 },
    { id: 'hws-005', tenantId: SCHOOL_ID, homeworkId: HW2, studentId: U.SCH_S2, submittedAt: new Date('2026-06-22'), isLate: false, status: 'submitted' },
  ]) {
  ...
  await prisma.teacherPayout.upsert({
    ...
    create: {
      id: 'tp-tara-june-1', tenantId: SCHOOL_ID, teacherId: U.SCH_T1,
  ...
  await prisma.teacherPayout.upsert({
    ...
    create: {
      id: 'tp-raj-june-01', tenantId: SCHOOL_ID, teacherId: U.SCH_T2,
      periodStart: new Date('2026-06-01'), periodEnd: new Date('2026-06-30'),
  ...
  await prisma.creditPackage.upsert({
    ...
    create: {
      id: 'cp-sara-june1', tenantId: SCHOOL_ID, studentId: U.SCH_S1,
  ...
  await prisma.creditPackage.upsert({
    ...
    create: {
      id: 'cp-arjun-jun1', tenantId: SCHOOL_ID, studentId: U.SCH_S2,
  ...
  for (const txn of [
    { id: 'ct-001', tenantId: SCHOOL_ID, packageId: 'cp-sara-june1', studentId: U.SCH_S1, transactionType: 'deduct', amount: -1, balanceAfter: 19, relatedClassId: 'sc-m1', notes: 'Class deduction: Math Class 1' },
    { id: 'ct-002', tenantId: SCHOOL_ID, packageId: 'cp-sara-june1', studentId: U.SCH_S1, transactionType: 'deduct', amount: -1, balanceAfter: 18, relatedClassId: 'sc-m2', notes: 'Class deduction: Math Class 2' },
    { id: 'ct-003', tenantId: SCHOOL_ID, packageId: 'cp-sara-june1', studentId: U.SCH_S1, transactionType: 'deduct', amount: -1, balanceAfter: 17, relatedClassId: 'sc-s1', notes: 'Class deduction: Science Class 1' },
    { id: 'ct-004', tenantId: SCHOOL_ID, packageId: 'cp-arjun-jun1', studentId: U.SCH_S2, transactionType: 'deduct', amount: -1, balanceAfter: 19, relatedClassId: 'sc-m1', notes: 'Class deduction: Math Class 1' },
    { id: 'ct-005', tenantId: SCHOOL_ID, packageId: 'cp-arjun-jun1', studentId: U.SCH_S2, transactionType: 'deduct', amount: -1, balanceAfter: 18, relatedClassId: 'sc-m2', notes: 'Class deduction: Math Class 2' },
  ]) {
  ...
  await prisma.meeting.upsert({
    where: { id: 'meet-sc-m1' },
    create: {
      id: 'meet-sc-m1', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m1', hostId: U.SCH_T1,
  ...
  await prisma.meeting.upsert({
    where: { id: 'meet-sc-m2' },
    create: {
      id: 'meet-sc-m2', tenantId: SCHOOL_ID, scheduledClassId: 'sc-m2', hostId: U.SCH_T1,
  ...
  await prisma.meeting.upsert({
    where: { id: 'meet-sc-s1' },
    create: {
      id: 'meet-sc-s1', tenantId: SCHOOL_ID, scheduledClassId: 'sc-s1', hostId: U.SCH_T2,
  ...
  // ── Question Bank ─────────────────────────────────────────────────────────
  for (const q of [
    { id: 'q-001', tenantId: SCHOOL_ID, createdBy: U.SCH_T1, subject: 'Math',       topic: 'Fractions',   difficulty: 'easy',   type: 'mcq',        text: 'What is 1/4 + 1/4?',                      options: [{ text: '1/2', isCorrect: true },{ text: '1/8', isCorrect: false },{ text: '2/8', isCorrect: false },{ text: '1/4', isCorrect: false }], points: 1 },
    { id: 'q-002', tenantId: SCHOOL_ID, createdBy: U.SCH_T1, subject: 'Math',       topic: 'Fractions',   difficulty: 'medium', type: 'mcq',        text: 'What is 3/5 − 1/5?',                     options: [{ text: '2/5', isCorrect: true },{ text: '4/5', isCorrect: false },{ text: '2/10', isCorrect: false },{ text: '1/5', isCorrect: false }], points: 1 },
    { id: 'q-003', tenantId: SCHOOL_ID, createdBy: U.SCH_T1, subject: 'Science',    topic: 'Plants',      difficulty: 'easy',   type: 'true_false', text: 'Photosynthesis requires sunlight.',        options: [{ text: 'True', isCorrect: true },{ text: 'False', isCorrect: false }], points: 1 },
    { id: 'q-004', tenantId: SCHOOL_ID, createdBy: U.SCH_T1, subject: 'Math',       topic: 'Geometry',    difficulty: 'easy',   type: 'mcq',        text: 'How many sides does a hexagon have?',     options: [{ text: '6', isCorrect: true },{ text: '5', isCorrect: false },{ text: '7', isCorrect: false },{ text: '8', isCorrect: false }], points: 1 },
    { id: 'q-005', tenantId: CORP_ID,   createdBy: U.CORP_ADMIN, subject: 'Safety', topic: 'Fire Safety', difficulty: 'easy',   type: 'mcq',        text: 'Fire emergency number in India?',         options: [{ text: '101', isCorrect: true },{ text: '100', isCorrect: false },{ text: '999', isCorrect: false },{ text: '112', isCorrect: false }], points: 2 },
    { id: 'q-006', tenantId: CORP_ID,   createdBy: U.CORP_ADMIN, subject: 'Compliance', topic: 'GDPR',    difficulty: 'medium', type: 'mcq',        text: 'Maximum GDPR fine for serious violation?', options: [{ text: '€20M or 4% turnover', isCorrect: true },{ text: '€10M or 2% turnover', isCorrect: false },{ text: '€5M or 1% turnover', isCorrect: false },{ text: '€50M or 10% turnover', isCorrect: false }], points: 3 },
    { id: 'q-007', tenantId: CORP_ID,   createdBy: U.CORP_ADMIN, subject: 'Safety',     topic: 'PPE',     difficulty: 'easy',   type: 'true_false', text: 'Hard hats must be worn in all site areas.',options: [{ text: 'True', isCorrect: true },{ text: 'False', isCorrect: false }], points: 1 },
  ]) {
  ...
  await prisma.exam.upsert({
    where: { id: EXAM1 },
    create: {
      id: EXAM1, tenantId: SCHOOL_ID, createdBy: U.SCH_T1, batchId: BATCH_MATH,
  ...
  await prisma.exam.upsert({
    where: { id: EXAM2 },
    create: {
      id: EXAM2, tenantId: CORP_ID, createdBy: U.CORP_ADMIN,
  ...
  await prisma.examSession.upsert({
    where: { id: 'es-001' },
    create: {
      id: 'es-001', tenantId: SCHOOL_ID, examId: EXAM1, studentId: U.SCH_S1,
  ...
  await prisma.conversation.upsert({
    where: { id: CONV1 },
    create: {
      id: CONV1, tenantId: SCHOOL_ID, type: 'direct',
  ...
  await prisma.conversation.upsert({
    where: { id: CONV2 },
    create: {
      id: CONV2, tenantId: SCHOOL_ID, type: 'group', title: 'Math 5A',
  ...
  await prisma.teacherLevel.upsert({
    ...
    create: {
      tenantId: SCHOOL_ID, teacherId: U.SCH_T1, currentLevel: 'lead', totalClassesTaught: 45,
  ...
  await prisma.teacherLevel.upsert({
    ...
    create: {
      tenantId: SCHOOL_ID, teacherId: U.SCH_T2, currentLevel: 'intermediate', totalClassesTaught: 22,
  ...
  await prisma.nonTeachingTask.upsert({
    where: { id: 'ntt-001' },
    create: {
      id: 'ntt-001', tenantId: SCHOOL_ID, teacherId: U.SCH_T1, assignedBy: U.SCH_ADMIN,
  ...
  await prisma.nonTeachingTask.upsert({
    where: { id: 'ntt-002' },
    create: {
      id: 'ntt-002', tenantId: SCHOOL_ID, teacherId: U.SCH_T2, assignedBy: U.SCH_ADMIN,
  ...
  await prisma.tutoringRequest.upsert({
    where: { id: 'tr-001' },
    create: {
      id: 'tr-001', tenantId: SCHOOL_ID, studentId: U.SCH_S2, teacherId: U.SCH_T1,
  ...
  // ── Activity Logs ─────────────────────────────────────────────────────────
  for (const log of [
    { id: 'al-001', type: 'course_created',  message: 'Course "Workplace Safety & Compliance" created',         tenantId: CORP_ID,   userId: U.CORP_ADMIN, timestamp: new Date('2026-06-01T10:00:00Z') },
    { id: 'al-002', type: 'course_created',  message: 'Course "Leadership Essentials" created',                 tenantId: CORP_ID,   userId: U.CORP_ADMIN, timestamp: new Date('2026-06-02T09:00:00Z') },
    { id: 'al-003', type: 'user_action',     message: 'User Leo Learner completed Workplace Safety course',     tenantId: CORP_ID,   userId: U.CORP_L1,   timestamp: new Date('2026-06-01T15:30:00Z') },
    { id: 'al-004', type: 'tenant_created',  message: 'Tenant Bright School onboarded to the platform',        tenantId: SCHOOL_ID, userId: U.SA,         timestamp: new Date('2026-05-01T09:00:00Z') },
    { id: 'al-005', type: 'upload',          message: 'New lesson video uploaded for Mathematics Grade 5',      tenantId: SCHOOL_ID, userId: U.SCH_T1,     timestamp: new Date('2026-06-10T11:00:00Z') },
    { id: 'al-006', type: 'user_action',     message: 'User Jake Engineer completed Workplace Safety course',   tenantId: CORP_ID,   userId: U.CORP_L3,   timestamp: new Date('2026-06-10T14:00:00Z') },
  ]) {
  ...
  // ── Tenant Logs ───────────────────────────────────────────────────────────
  for (const tl of [
    { id: 'tl-001', tenantId: CORP_ID,   actionType: 'NewLearnerInvited',        description: 'New employee Leo Learner invited to Acme Corp',      performedBy: U.CORP_ADMIN, createdAt: new Date('2026-05-20T09:00:00Z') },
    { id: 'tl-002', tenantId: CORP_ID,   actionType: 'CourseAssignedToUser',     description: 'Safety course assigned to Leo Learner',              performedBy: U.CORP_ADMIN, createdAt: new Date('2026-06-01T09:00:00Z') },
    { id: 'tl-003', tenantId: CORP_ID,   actionType: 'CourseCompleted',          description: 'Leo Learner completed Workplace Safety & Compliance', performedBy: U.CORP_L1,   createdAt: new Date('2026-06-01T15:30:00Z') },
    { id: 'tl-004', tenantId: CORP_ID,   actionType: 'BrandingUpdated',          description: 'Tenant branding updated by Aria Admin',               performedBy: U.CORP_ADMIN, createdAt: new Date('2026-06-05T11:00:00Z') },
    { id: 'tl-005', tenantId: SCHOOL_ID, actionType: 'NewLearnerInvited',        description: 'New student Sara Student enrolled at Bright School',  performedBy: U.SCH_ADMIN,  createdAt: new Date('2026-04-01T09:00:00Z') },
    { id: 'tl-006', tenantId: SCHOOL_ID, actionType: 'AttendanceMarkedByManager',description: 'Attendance marked for Math Class 1 – Fractions',     performedBy: U.SCH_T1,    createdAt: new Date('2026-06-02T10:15:00Z') },
    { id: 'tl-007', tenantId: CORP_ID,   actionType: 'CourseAssignedToGroup',    description: 'Safety course assigned to Engineering Team group',     performedBy: U.CORP_ADMIN, createdAt: new Date('2026-06-01T09:30:00Z') },
    { id: 'tl-008', tenantId: CORP_ID,   actionType: 'UserActivated',            description: 'User Emma Employee account activated',                performedBy: U.CORP_ADMIN, createdAt: new Date('2026-06-08T10:00:00Z') },
  ]) {
