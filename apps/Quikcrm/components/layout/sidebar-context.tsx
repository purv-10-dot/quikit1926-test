...
/** Tailwind's `xl` breakpoint. Below this, the sidebar starts collapsed by
 * default — 13" laptops (1280×800) sit right around here, and the leads/
 * accounts tables need every available pixel. Users who toggle the sidebar
 * persist their choice in localStorage and override the auto-default. */
const AUTO_COLLAPSE_BREAKPOINT_PX = 1280;
