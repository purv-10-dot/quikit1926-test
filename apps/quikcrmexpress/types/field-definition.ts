...
export const STANDARD_LEAD_FIELDS: LeadFieldDefinition[] = [
  ...
  // Sub Status is a real standard column (QceLead.substatus, nullable). It is
  ...
  // Lead Quality is a real standard column (QceLead.leadQuality, nullable). It
  ...
  // Country is a real standard column (QceLead.country, nullable). Like
