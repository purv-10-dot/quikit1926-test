...
const orgId =
  ...
  (
    await prisma.qceFormSet.findFirst({
...
const set = await prisma.qceFormSet.findFirst({
...
const draft = await prisma.qceFormSetVersion.findFirst({
...
const rules = await prisma.qceFormRule.findMany({
...
const a = await prisma.qceFormRuleAction.deleteMany({ where: { formRuleId: { in: ids } } });
const c = await prisma.qceFormRuleCondition.deleteMany({ where: { formRuleId: { in: ids } } });
const r = await prisma.qceFormRule.deleteMany({ where: { id: { in: ids } } });
