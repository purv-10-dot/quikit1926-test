...
export function NotificationBell() {
  ...
  // Live pop-up when a new notification arrives over SSE. The panel + badge are
  // refreshed inside the hook; here we just surface a subtle toast.
  const handleIncoming = useCallback(
    (n: IncomingNotification) => {
      toast.rich(n.title, n.body ?? "", "info");
    },
    [toast],
  );

  // One SSE connection per mounted bell — drives real-time badge + toast.
  useNotificationStream(true, handleIncoming);
