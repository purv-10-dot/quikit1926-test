...
export function OpportunityKanban({
  ...
  const [pendingClose, setPendingClose] = useState<
    | { id: string; toStage: "ClosedWon" | "ClosedLost"; fromStage: QceOpportunityStage }
    | null
  >(null);
  ...
  const transition = useMutation({
    ...
    onMutate: async ({ id, toStage }) => {
      ...
      let fromStage: QceOpportunityStage | null = null;
  ...
  function findCard(id: string): { card: DealCard; stage: QceOpportunityStage } | null {
  ...
  function onDragEnd(e: DragEndEvent) {
    ...
    const targetStage = overId.slice(4) as QceOpportunityStage;
