 ...
 * canonical enum value. Documented in apps/quikcrmexpress/CLAUDE.md.
 */
import type { QceOpportunityStage } from "@quikit/database";

export const STAGE_LABEL: Record<QceOpportunityStage, string> = {
...
export const STAGE_ORDER: QceOpportunityStage[] = [
  "Prospecting",
  "Qualification",
  "Proposal",
  "Negotiation",
...
export const TERMINAL_STAGES: ReadonlySet<QceOpportunityStage> = new Set([
  "ClosedWon",
  "ClosedLost",
]);

/** Server-side default probability per stage. UI suggests; user confirms. */
export const STAGE_DEFAULT_PROBABILITY: Record<QceOpportunityStage, number> = {
  Prospecting: 10,
  Qualification: 25,
  Proposal: 50,
  Negotiation: 75,
