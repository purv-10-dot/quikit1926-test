/**
 * Advanced filter + quick search for QceOpportunity.
...
export function buildOpportunityQuickSearchWhere(
  term: unknown,
): Prisma.QceOpportunityWhereInput | null {
...
export function buildAdvancedOpportunityWhere(
  ...
  const built: Prisma.QceOpportunityWhereInput[] = [];
...
function buildSingleCondition(c: RawCondition): Prisma.QceOpportunityWhereInput | null {
  ...
  switch (operator) {
    case "eq":
      if (INSENSITIVE_EQ_FIELDS.has(field) && typeof c.value === "string") {
        return { [field]: { equals: c.value, mode: "insensitive" } } as Prisma.QceOpportunityWhereInput;
      }
      return { [field]: c.value } as Prisma.QceOpportunityWhereInput;
    case "ne":
      if (INSENSITIVE_EQ_FIELDS.has(field) && typeof c.value === "string") {
        return {
          NOT: { [field]: { equals: c.value, mode: "insensitive" } },
        } as Prisma.QceOpportunityWhereInput;
      }
      return { NOT: { [field]: c.value } } as Prisma.QceOpportunityWhereInput;
    case "contains":
      return {
    ...
    case "in":
      return { [field]: { in: c.values ?? [] } } as Prisma.QceOpportunityWhereInput;
    case "notIn":
      return { [field]: { notIn: c.values ?? [] } } as Prisma.QceOpportunityWhereInput;
    case "isNull":
      return { [field]: null } as Prisma.QceOpportunityWhereInput;
    case "notNull":
      return { NOT: { [field]: null } } as Prisma.QceOpportunityWhereInput;
    default:
      return null;
  }
}
...
function buildDateCondition(
  ...
  switch (operator) {
    case "eq": {
      ...
      if (!d) return null;
      return { [field]: { gte: startOfDay(d), lte: endOfDay(d) } } as Prisma.QceOpportunityWhereInput;
    }
    case "gt": {
      const d = parseFilterDate(c.value);
      if (!d) return null;
      return { [field]: { gt: endOfDay(d) } } as Prisma.QceOpportunityWhereInput;
    }
    case "gte": {
      const d = parseFilterDate(c.value);
      if (!d) return null;
      return { [field]: { gte: startOfDay(d) } } as Prisma.QceOpportunityWhereInput;
    }
    case "lt": {
      const d = parseFilterDate(c.value);
      if (!d) return null;
      return { [field]: { lt: startOfDay(d) } } as Prisma.QceOpportunityWhereInput;
    }
    case "lte": {
      const d = parseFilterDate(c.value);
      if (!d) return null;
      return { [field]: { lte: endOfDay(d) } } as Prisma.QceOpportunityWhereInput;
    }
    case "between": {
...
function buildNumericCondition(
  ...
  switch (operator) {
    case "eq": {
      ...
      return { [field]: n } as Prisma.QceOpportunityWhereInput;
    }
    case "ne": {
      const n = coerceNumber(c.value);
      if (n == null) return null;
      return { NOT: { [field]: n } } as Prisma.QceOpportunityWhereInput;
    }
    case "gt": {
      const n = coerceNumber(c.value);
      if (n == null) return null;
      return { [field]: { gt: n } } as Prisma.QceOpportunityWhereInput;
    }
    case "gte": {
      const n = coerceNumber(c.value);
      if (n == null) return null;
      return { [field]: { gte: n } } as Prisma.QceOpportunityWhereInput;
    }
    case "lt": {
      const n = coerceNumber(c.value);
      if (n == null) return null;
      return { [field]: { lt: n } } as Prisma.QceOpportunityWhereInput;
    }
    case "lte": {
      const n = coerceNumber(c.value);
      if (n == null) return null;
      return { [field]: { lte: n } } as Prisma.QceOpportunityWhereInput;
    }
    case "between": {
      if (!Array.isArray(c.values) || c.values.length !== 2) return null;
      ...
      const [lo, hi] = a <= b ? [a, b] : [b, a];
      return { [field]: { gte: lo, lte: hi } } as Prisma.QceOpportunityWhereInput;
    }
    case "isNull":
      return { [field]: null } as Prisma.QceOpportunityWhereInput;
    case "notNull":
...
export function buildOpportunityFilterWhere(args: {
  ...
  combinator: "AND" | "OR";
  search?: string;
}): Prisma.QceOpportunityWhereInput {
  const parts: Prisma.QceOpportunityWhereInput[] = [
    {
      orgId: args.orgId,
      deletedAt: null,
      ...(args.aclFilter ? (args.aclFilter as Prisma.QceOpportunityWhereInput) : {}),
    },
  ];
