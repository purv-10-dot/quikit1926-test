...
export function buildProductSearchWhere(p: ProductSearchFilters): Prisma.QceProductWhereInput {
  const and: Prisma.QceProductWhereInput[] = [
    { orgId: p.orgId },
