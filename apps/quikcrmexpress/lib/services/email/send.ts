 ...
 *
 *         RESEND_API_KEY=re_xxx        # in apps/quikcrmexpress/.env.local
 *         EMAIL_FROM="Sales <sales@yourdomain.com>"
 *         EMAIL_PROVIDER=resend
 *         npm i resend --workspace=apps/quikcrmexpress   # gate on PR justification per CLAUDE.md
 *
 ...
 *   1. PR justification per apps/quikcrmexpress/CLAUDE.md:
 *        npm i resend --workspace=apps/quikcrmexpress
 *   2. apps/quikcrmexpress/.env.local:
 ...
 * `api-key` header keeps this dependency-free (apps/quikcrmexpress/CLAUDE.md #3).
