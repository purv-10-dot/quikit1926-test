import type { QceCampaign } from "@quikit/database";
...
function readConfig(config: QceCampaign["config"]): Record<string, unknown> {
...
export function serializeCampaign(c: QceCampaign): CampaignDetailDto {
