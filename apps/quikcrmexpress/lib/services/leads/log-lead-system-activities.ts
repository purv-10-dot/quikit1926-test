/**
 * System-generated QceActivity rows when a lead is created (HubSpot / Salesforce pattern).
...
function formatDetailBlock(lead: QceLead, channel: LeadCreationChannel, ctx: LeadCreationContext): string {
