...
export default async function OpportunityDetailPage({
  ...
  const o = await prisma.qceOpportunity.findFirst({
  ...
  const lead = o.leadId
    ? await prisma.qceLead.findFirst({
