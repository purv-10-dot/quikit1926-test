...
export default async function ImportsPage() {
  ...
  const jobs = await prisma.qceLeadImportJob.findMany({
        ...
        <Card>
          ...
          <CardBody>
            ...
            <p className="mt-3 flex flex-wrap items-center gap-x-1 gap-y-2 text-xs text-crm-muted">
              <span>
                Only <strong>name</strong> is required. CSV headers are matched to your Lead
                fields by key or label — standard fields (email, phone, mobile, company, jobTitle,
                source, stage, status, …) <em>and</em> any custom fields you’ve added. Custom fields
                are validated and stored exactly like a manually created lead.
              </span>
