...
export async function PATCH(
  ...
  try {
    ...
    const product = await db.qceOpportunityProduct.findFirst({
    ...
    const updated = await db.qceOpportunityProduct.update({
      where: { id: productId },
      data: {
        ...parsed.data,
...
export async function DELETE(
  ...
  try {
    ...
    const result = await db.qceOpportunityProduct.deleteMany({
      where: { id: productId, orgId: user.orgId, opportunityId: id },
    });
