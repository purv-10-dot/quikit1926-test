 ...
 * role via the admin portal) without having UserAppAccess for CrmExpress yet.
 * The autocomplete surfaces those users so an admin can grant CrmExpress access
 ...
 *   - "Add to CrmExpress"     → POST with linkExistingUserId
 *   - "Already in CrmExpress" → disabled / informational
 *
