...
export async function POST(req: NextRequest) {
  try {
    ...
    const baseWhere: Prisma.QceAccountWhereInput = applyAccountListWhere(
      { orgId: user.orgId },
    ...
    const andParts: Prisma.QceAccountWhereInput[] = [baseWhere];
    ...
    if (topLevelOnly) {
      ...
      Object.assign(where, {
        AND: [
          ...((where.AND as Prisma.QceAccountWhereInput[] | undefined) ?? [where]),
