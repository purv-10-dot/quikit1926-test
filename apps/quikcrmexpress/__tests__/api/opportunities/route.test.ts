...
describe("GET /api/opportunities", () => {
  beforeEach(() => {
    ...
    db.qceOpportunity.count.mockReset();
    db.qceUserAccountAccess.findMany.mockReset();
    db.qceSalesGroupMember.findMany.mockReset();
    db.qceSalesGroupManager.findMany.mockReset();
    db.qceSalesGroupAccount.findMany.mockReset();
  ...
  it("returns the {success, data} envelope on a happy GET", async () => {
    ...
    db.qceUserAccountAccess.findMany.mockResolvedValue([]);
    db.qceSalesGroupMember.findMany.mockResolvedValue([]);
    db.qceSalesGroupManager.findMany.mockResolvedValue([]);
    db.qceSalesGroupAccount.findMany.mockResolvedValue([]);
    ...
    db.qceOpportunity.count.mockResolvedValue(1);
