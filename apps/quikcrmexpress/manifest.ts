...
const manifest: AppManifest = {
  appId: "quikcrmexpress",
  name: "QuikCRMExpress",
  description: "Leads, accounts, contacts, opportunities, automations, and telephony — sales execution.",
  routePrefix: "/quikcrmexpress",
  icon: "Users",
  /**
   * Capabilities this app exposes to the platform, in the house
   * `<appId>.<domain>.<action>` form (see apps/quiksupport/manifest.ts).
   *
   * This was an empty array, so the launcher — which reads each manifest to
   * build the platform-wide permissions list — could not surface anything for
   * QuikCRMExpress, and there was nothing for an admin to assign against.
   *
   * These name the app's real modules (the ones `assertModule` gates on in
   * lib/auth/permissions.ts). Deliberately the meaningful capability set
   * rather than a mechanical module × action cross-product, which would be
   * 119 entries nobody could reason about.
   */
  permissions: [
    "quikcrmexpress.lead.view",
    "quikcrmexpress.lead.create",
    "quikcrmexpress.lead.edit",
    "quikcrmexpress.lead.delete",
    "quikcrmexpress.lead.import",
    "quikcrmexpress.account.manage",
    "quikcrmexpress.contact.manage",
    "quikcrmexpress.opportunity.manage",
    "quikcrmexpress.opportunity.transition",
    "quikcrmexpress.quote.manage",
    "quikcrmexpress.quote.send",
    "quikcrmexpress.order.manage",
    "quikcrmexpress.activity.manage",
    "quikcrmexpress.task.manage",
    "quikcrmexpress.telephony.call",
    "quikcrmexpress.telephony.viewLogs",
    "quikcrmexpress.automation.manage",
    "quikcrmexpress.report.view",
    "quikcrmexpress.report.export",
    "quikcrmexpress.settings.manage",
    "quikcrmexpress.user.manage",
    "quikcrmexpress.role.manage",
  ],
