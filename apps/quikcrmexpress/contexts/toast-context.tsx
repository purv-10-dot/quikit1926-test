...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ToastContext.Provider value={value}>
      ...
      <div
        className="pointer-events-none fixed bottom-4 left-4 z-[100] flex w-[min(100vw-2rem,22rem)] flex-col gap-2.5 font-[family-name:var(--font-jakarta)]"
        aria-live="polite"
        aria-atomic="false"
      >
        {items.map((t) => {
            ...
            return (
              <div
                ...
                className={[
                  ...
                  "animate-in slide-in-from-left-4 fade-in-0 duration-200 ease-out",
                ].join(" ")}
              >
                {/* Circular icon badge */}
                <span
