...
const manifest: AppManifest = {
  appId: "quikvc",
  name: "QuikVC",
  description: "AI-powered operating system for venture capital firms — deal lifecycle, IC memos, capital allocation",
  routePrefix: "/quikvc",
  icon: "Box",
  permissions: [],
  navigation: [
    { label: "Dashboard", href: "/quikvc", icon: "LayoutDashboard" },
  ],
};
