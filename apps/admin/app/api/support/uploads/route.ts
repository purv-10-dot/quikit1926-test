/**
 * Attachment uploads for support requests raised from the Admin Portal.
 *
 ...
 * file only supplies the Admin Portal's auth guard.
 *
...
export const POST = withMemberAuth(async ({ orgId }, req: NextRequest) => {
  let form: FormData;
  try {
