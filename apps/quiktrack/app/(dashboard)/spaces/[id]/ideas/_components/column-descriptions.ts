...
export const COLUMN_DESCRIPTIONS: Record<string, string> = {
  ...
  delivery: "An estimation of delivery work items such as epics that are linked to the idea. For more details open each idea and the “Delivery” section",
  delivery_status: "The status of delivery work items that are linked to the idea. For more details open each idea and the “Delivery” section",
  atlassian_project: "The project this idea is connected to",
  ...
  linked_items: "Number of work items linked to an idea",
