...
Twenty-eight architectural decisions are observable in CredFlow's code. For **ten** of them, the repository states the reasoning — in a docblock, an inline comment, or a platform architecture document. Those ten are written up here as ADRs.
