 ...
 *
 *         RESEND_API_KEY=re_xxx        # in apps/quikcredflow/.env.local
 *         EMAIL_FROM="Sales <sales@yourdomain.com>"
 *         EMAIL_PROVIDER=resend
 *         npm i resend --workspace=apps/quikcredflow   # gate on PR justification per CLAUDE.md
 *
 ...
 *   1. PR justification per apps/quikcredflow/CLAUDE.md:
 *        npm i resend --workspace=apps/quikcredflow
 *   2. apps/quikcredflow/.env.local:
 ...
 * `api-key` header keeps this dependency-free (apps/quikcredflow/CLAUDE.md #3).
