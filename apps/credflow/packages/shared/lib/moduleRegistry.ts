...
export const MODULE_REGISTRY: AppModuleConfig[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { key: "opportunities", label: "Opportunities", icon: "Briefcase", href: "/opportunities" },
      { key: "documents", label: "Documents", icon: "Files", href: "/documents" },
      { key: "inventory", label: "Inventory", icon: "Folder" },
      { key: "inventory.quotes", label: "Quotes", icon: "FileText", href: "/quotes", parentKey: "inventory" },
      { key: "inventory.orders", label: "Orders", icon: "PackageCheck", href: "/orders", parentKey: "inventory" },
      { key: "inventory.products", label: "Products", icon: "Package", href: "/products", parentKey: "inventory" },
      { key: "inventory.priceLists", label: "Price Lists", icon: "Tags", href: "/price-lists", parentKey: "inventory" },
      { key: "activities", label: "Activities", icon: "Activity" },
      { key: "activities.log", label: "Activities", icon: "Activity", href: "/activities", parentKey: "activities" },
      { key: "activities.tasks", label: "Tasks", icon: "CheckSquare", href: "/tasks", parentKey: "activities" },
      { key: "activities.telephony", label: "Telephony", icon: "Phone", href: "/telephony/dialer", parentKey: "activities" },
      { key: "activities.automations", label: "Automations", icon: "Workflow", href: "/automations/workflows", parentKey: "activities" },
      { key: "activities.reports", label: "Reports", icon: "BarChart3", href: "/reports", parentKey: "activities" },
      { key: "marketing", label: "Campaigns", icon: "Megaphone", href: "/marketing/campaigns" },
