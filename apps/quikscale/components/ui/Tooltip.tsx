...
/**
 * Base tooltip primitive for the quikscale app.
 *
 * Handles the boilerplate shared by NameTooltip, DescTooltip, WeekTooltip:
 ...
 *
 * Domain-specific tooltips (NameTooltip etc.) supply the content and tweak
 * width/alignment via `widthClass` and `arrow` props.
 */
