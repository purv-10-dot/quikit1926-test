...
/**
 * AI Copilot chat view — message list, typing indicator and composer, ported
 * from the reference widget.
 *
 * Conversation state lives here rather than in the panel, so it resets whenever
 * the view unmounts — matching the reference, where entering chat always starts
 * fresh from the greeting.
 *
 * Replies come from the scripted KB in lib/support/assistantKb.ts (no backend,
 * as in the reference). `replyTo` is the single seam to swap for a real LLM call.
 */

import { useEffect, useRef, useState } from "react";
import { Send, Sparkles } from "lucide-react";
import { ASSISTANT_GREETING, replyTo } from "@/lib/support/assistantKb";
...
/** Matches the reference's fake-latency so the typing indicator is perceptible. */
