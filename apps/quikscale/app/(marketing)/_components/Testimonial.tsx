...
const QUOTE =
  "“Finally, a tool that doesn’t force CEOs to translate their vision into someone else’s framework. QuikScale simply adapts to the way leaders already think and operate.”";
