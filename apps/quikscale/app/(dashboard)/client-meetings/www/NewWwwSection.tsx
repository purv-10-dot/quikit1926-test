        ...
        <table className="w-full text-left text-xs">
          <thead>
            <tr className="bg-accent-50">
              ...
              <th className="px-3 py-1.5 font-semibold text-gray-700">Who</th>
                ...
                >
                  ...
                  <td className="px-3 py-1.5 text-gray-800">
                    {needsOwner && editable && r.factId ? (
                      ...
                      >
                        <option value="">{owner ? `${owner} — confirm` : "Choose an owner…"}</option>
                        {ownerOptions!.map((u) => (
                  ...
                  <td className="px-3 py-1.5 text-gray-800">{r.what ?? "—"}</td>
