/**
 * FF-1 route gate for "orgSetup.teams" module. Redirects to /dashboard?feature_disabled=orgSetup.teams
...
export default async function FeatureFlagLayout({ children }: { children: React.ReactNode }) {
  await gateModuleRoute("quikscale", "orgSetup.teams", authOptions);
  return <>{children}</>;
}
