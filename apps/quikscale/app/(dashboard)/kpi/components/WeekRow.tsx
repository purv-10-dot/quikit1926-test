...
export function WeekRow({
  ...
  lockReason?: string;
  /** Compact unit (e.g. "Cr") shown beside the value input for scaled currency KPIs. */
  unitSuffix?: string;
}) {
      ...
      <div className="w-24 flex-shrink-0">
        <div className="flex items-center gap-1">
          <input
            ...
            placeholder="—"
            readOnly={locked}
            className={`min-w-0 flex-1 px-2 py-1.5 text-xs border rounded-md focus:outline-none text-center ${locked ? "border-gray-100 bg-gray-50 text-gray-400 cursor-not-allowed" : "border-gray-200 focus:ring-1 focus:ring-accent-400"}`}
          />
