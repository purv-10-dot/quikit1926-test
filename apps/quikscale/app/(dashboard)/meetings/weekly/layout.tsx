/**
 * FF-1 route gate for "meetings.weekly" module. Redirects to /dashboard?feature_disabled=meetings.weekly
...
export default async function FeatureFlagLayout({ children }: { children: React.ReactNode }) {
  await gateModuleRoute("quikscale", "meetings.weekly", authOptions);
  return <>{children}</>;
}
