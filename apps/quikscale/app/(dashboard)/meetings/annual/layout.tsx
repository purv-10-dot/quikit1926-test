/**
 * FF-1 route gate for "meetings.annual" module. Redirects to /dashboard?feature_disabled=meetings.annual
...
export default async function FeatureFlagLayout({ children }: { children: React.ReactNode }) {
  await gateModuleRoute("quikscale", "meetings.annual", authOptions);
  return <>{children}</>;
}
