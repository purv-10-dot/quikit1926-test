/**
 * FF-1 route gate for "meetings.history" module. Redirects to /dashboard?feature_disabled=meetings.history
...
export default async function FeatureFlagLayout({ children }: { children: React.ReactNode }) {
  await gateModuleRoute("quikscale", "meetings.history", authOptions);
  return <>{children}</>;
}
