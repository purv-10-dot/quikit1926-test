/**
 * FF-1 route gate for "people.feedback" module. Redirects to /dashboard?feature_disabled=people.feedback
...
export default async function FeatureFlagLayout({ children }: { children: React.ReactNode }) {
  await gateModuleRoute("quikscale", "people.feedback", authOptions);
  return <>{children}</>;
}
