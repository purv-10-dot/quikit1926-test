/**
 * FF-1 route gate for "analytics.teams" module. Redirects to /dashboard?feature_disabled=analytics.teams
...
export default async function FeatureFlagLayout({ children }: { children: React.ReactNode }) {
  await gateModuleRoute("quikscale", "analytics.teams", authOptions);
  return <>{children}</>;
}
