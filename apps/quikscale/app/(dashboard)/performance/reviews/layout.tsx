/**
 * FF-1 route gate for "people.reviews" module. Redirects to /dashboard?feature_disabled=people.reviews
...
export default async function FeatureFlagLayout({ children }: { children: React.ReactNode }) {
  await gateModuleRoute("quikscale", "people.reviews", authOptions);
  return <>{children}</>;
}
