 ...
 * every app; this file only supplies the app's own auth guard and slug.
 *
...
export const POST = withOrgAuth(
  ...
  {
    // Rate limiting is applied inside `createSupportTicket` (a tighter bucket
    // than the shared mutation one, shared across every app), so the wrapper's
    // default mutation limiter is turned off here rather than stacked on top.
