...
export function ImportDataDrawer({
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="fixed right-0 top-0 bottom-0 max-w-3xl w-full bg-white shadow-2xl flex flex-col z-50">
        {/* Header */}
        <div className="px-6 py-4 border-b border-gray-200 bg-blue-50/40 flex items-center justify-between shrink-0">
          <div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
            ...
            <>
              <label
                ...
                className={`block rounded-2xl border-2 border-dashed py-16 px-6 text-center cursor-pointer transition-colors ${
                  isDragging ? "border-blue-400 bg-blue-50/60" : "border-gray-300 bg-white hover:bg-gray-50"
                }`}
              >
                <input
                  ref={fileInputRef}
                ...
                />
                <div className="w-14 h-14 rounded-xl bg-blue-50 text-blue-500 flex items-center justify-center mx-auto mb-3">
          ...
          {stage === "map" && (
            <>
              <div className="flex items-center gap-3 mb-4 px-3 py-2 rounded-lg bg-blue-50/60 border border-blue-100 text-xs text-blue-800">
