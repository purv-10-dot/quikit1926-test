                ...
                {selectedVendor && (
                  <>
                    ...
                    <section>
                      ...
                      <label
                        htmlFor="quote-file"
                        className="flex items-center gap-3 px-3 py-2.5 rounded-xl border-2 border-dashed border-gray-300 text-sm cursor-pointer hover:border-orange-400 hover:bg-orange-50/30 transition-colors"
                      >
