...
export const USER_TYPE_CATALOG: UserTypeDescriptor[] = [
  {
    ...
    backingRole: ROLE_KEYS.PLATFORM_SUPER_ADMIN,
    crossSite: true,
  ...
  },
  {
    ...
    backingRole: ROLE_KEYS.TENANT_ADMIN,
    crossSite: true,
    requiresModuleAssignment: false,
    requiresSiteAssignment: false,
  },
  {
    ...
    shortDescription:
      ...
      "specific documents.",
    clientSelectable: true,
    backingRole: ROLE_KEYS.PROJECT_DIRECTOR,
    crossSite: true,
  ...
  },
  {
    ...
    clientSelectable: true,
    backingRole: ROLE_KEYS.PROJECT_MANAGER,
    crossSite: false,
    requiresModuleAssignment: true,
  ...
  },
  {
    ...
    clientSelectable: true,
    backingRole: ROLE_KEYS.SITE_ENGINEER,
    crossSite: false,
    requiresModuleAssignment: true,
    requiresSiteAssignment: true,
  },
 ...
 * — see CONSTRUCTION_NAV in QuikConstructionShell.tsx. When you add a
