  ...
  sections: [
    {
      ...
      children: [
        new Paragraph({
          style: "Title",
          children: [new TextRun("QuikConstruction")],
        }),
        new Paragraph({
          style: "Subtitle",
        ...
        new Paragraph({
          ...
          children: [new TextRun("What is QuikConstruction?")],
        }),
        new Paragraph({
          spacing: { after: 200 },
          children: [
            new TextRun(
              "QuikConstruction is an end-to-end Construction ERP built for builders, contractors, and infrastructure companies. It brings every part of a construction business — site execution, procurement, stores, finance, manpower, quality, and safety — into one connected system, replacing the patchwork of spreadsheets, email approvals, and disconnected tools that most firms rely on today."
            ),
          ],
        }),
        ...
        new Paragraph({
          ...
          children: [
            new TextRun(
              "Construction projects bleed money in the gaps — between the site engineer raising an indent and the store issuing material, between the vendor delivering goods and finance releasing payment, between the BOQ on paper and the actual work billed at the end of the month. QuikConstruction closes these gaps by tying every transaction to a project, a cost centre, and an approval trail, so nothing happens off-the-books and nothing gets lost between departments."
            ),
          ],
        }),
...
const outPath = path.join(
  ...
  "QuikConstruction-Product-Overview.docx"
);
