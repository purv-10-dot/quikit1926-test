  ...
  return (
    <>
      ...
      <div className="doc-head">
        <div><div className="company">QuikConstruction</div><div style={{ fontSize: 10, color: "#555" }}>Purchase Order</div></div>
      ...
      <div className="sig-block"><div className="sig">Vendor acknowledgment</div><div className="sig">For QuikConstruction</div></div>
