          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm px-6 py-5">
              <div className="flex items-center gap-3 mb-5">
                <span className="w-9 h-9 rounded-md flex items-center justify-center bg-blue-50 text-blue-600 border border-blue-200">
            ...
            {st.ewayBillNo && (
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm px-5 py-3 text-xs text-gray-700 flex items-center gap-3">
                ...
                <span className="font-mono">{st.ewayBillNo}</span>
                {st.interstateTransfer && (
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm px-5 py-4">
              ...
              <dl className="space-y-3 text-xs">
                ...
                />
                {st.approvedBy && (
                  <AuditField label="Approved By" value={st.approvedBy} />
                )}
                {st.dispatchedAt && (
                  <AuditField
                    label="Dispatched At"
