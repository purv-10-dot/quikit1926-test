...
import { useCostCenters, useCreateCostCenter, useUpdateCostCenter, useProjects } from "@/hooks/use-masters";
...
export default function CostCentersPage() {
  ...
  return (
    <>
      <MasterListPage title="Cost Centers" entityName="Cost Center" columns={columns}
