            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
                ...
                <div className="lg:col-span-4 bg-gradient-to-br from-gray-50 to-white border-t lg:border-t-0 lg:border-l border-gray-100 p-5 flex flex-col gap-3">
                  <div className="rounded-lg bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 px-4 py-3">
              ...
              {boqItems.length === 0 ? (
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full text-sm">
                    ...
                    <tfoot className="bg-gradient-to-r from-orange-50/60 via-amber-50/40 to-white border-t border-gray-200">
                      <tr>
                        <td
