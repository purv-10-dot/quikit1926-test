 ...
 *   STRICT_TEMPLATE — force the QuikConstruction 6-column template
...
const MODE_LABEL: Record<ImportMode, string> = {
  AUTO: "Auto Detect",
  STRICT_TEMPLATE: "QuikConstruction Template",
...
export function BOQImportDrawer({ open, onClose, projectId }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className={`fixed right-0 top-0 bottom-0 w-full ${selfFillActive ? "max-w-6xl" : "max-w-3xl"} bg-white shadow-2xl flex flex-col z-50 transition-[max-width]`}>
        {/* Header */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                ...
                >
                  ...
                  <div className="min-w-0">
                    <div className="text-xs font-semibold text-gray-900">QuikConstruction Template</div>
          ...
          {stage === "pick" && projectId && mode !== "SELF_FILL" && mode !== "STRICT_TEMPLATE" && (
            ...
            >
              ...
              <p className="text-xs text-gray-500">
                Supports both the strict QuikConstruction template and generic SOR BOQ formats.
              </p>
              <input
                ref={fileInputRef}
                type="file"
