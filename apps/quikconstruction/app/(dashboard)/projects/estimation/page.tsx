...
export default function EstimationPage() {
  ...
  const { me, permissionMatrix, isSuper, hasRole, hasModule } = usePermissions();
  ...
  // Approve = a privileged role can action a pending row. Until a
  // dedicated `pm.estimation.approve` permission exists, we use
  // tenant-admin / super-admin role membership as the gate. This
  // matches how the PO/RFQ approve bar falls back when no explicit
  // permission key is configured.
  const canApprove =
