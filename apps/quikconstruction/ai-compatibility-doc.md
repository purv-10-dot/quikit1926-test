# QuikConstruction — AI Runtime Compatibility Document
...
```
App slug:           quikconstruction
App name:           QuikConstruction
App key:            quikconstruction
...
Repository:         apps/quikconstruction in QuikIT monorepo
Provider order:     SessionProvider → QueryClientProvider → ThemeProvider
Login route:        /login
Middleware:         Custom (apps/quikconstruction/middleware.ts) — does NOT use
...
- **Two Prisma schemas exist** and they disagree:
  - `apps/quikconstruction/prisma/schema.prisma` (2391 lines) — **historical/local**, uses `tenantId + orgId` dual-scope, references models by old names. Some code paths still reference its shape.
...
### 2a. Local app schema (apps/quikconstruction/prisma/schema.prisma)

> Verbatim copy of the local schema is **omitted from this document** to keep it readable (2391 lines). Read directly from the repo at `apps/quikconstruction/prisma/schema.prisma`. Models are `Cn*` prefixed and live in the `app_quikconstruction` Postgres schema. Below is the full model list extracted from that file.
...
|---|---|---|---|---|---|---|---|
| CnCompany | app_quikconstruction | Yes | ✅ | ✅ | ✅ | manifest only | ❌ |
| CnVendor | app_quikconstruction | Yes | ✅ | ✅ | ✅ | manifest only | ❌ |
| CnCustomer | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnContractor | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnProject | app_quikconstruction | **Yes (key)** | ✅ | ✅ | ✅ | manifest only | ❌ |
| CnItem | app_quikconstruction | Yes | ✅ | ✅ | ✅ | manifest only | ❌ |
| CnPurchaseRequisition | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnPurchaseIndent | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnRFQ | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnPurchaseOrder | app_quikconstruction | **Yes (key)** | ✅ | ✅ | ✅ | manifest only | ❌ |
| CnGoodsReceiptNote | app_quikconstruction | **Yes (key)** | ✅ | ✅ | ✅ | manifest only | ❌ |
| CnMaterialIssue | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnStockTransfer | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnStockReconciliation | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnGatePass | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnGoodReturn | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnDieselLog | app_quikconstruction | Yes | ✅ | ✅ | ❌ (no soft delete) | — | ❌ |
| CnAsset | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnBOQ | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnBOQItem (legacy) | app_quikconstruction | Yes | ✅ | ✅ | ❌ | — | ❌ |
| CnBOQItemV2 | app_quikconstruction | Yes (current) | ✅ | ✅ | ✅ (soft delete) | — | ❌ |
| CnDPR | app_quikconstruction | **Yes (key)** | ✅ | ✅ | ✅ | — | ❌ |
| CnEstimation | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnHindrance | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnWorkOrder | app_quikconstruction | **Yes (key)** | ✅ | ✅ | ✅ | manifest only | ❌ |
| CnRAB | app_quikconstruction | **Yes (key)** | ✅ | ✅ | ✅ | — | ❌ |
| CnClientInvoice | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnClientReceipt | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnVendorBill | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnVendorPayment | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnCreditNote | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnDebitNote | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnExpense | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnEmployee | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnAttendance | app_quikconstruction | No (transactional) | ✅ | ✅ | ❌ | — | ❌ |
| CnPayroll | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnApprovalRequest | app_quikconstruction | Yes | ✅ | ✅ | ❌ | — | ❌ |
| CnSafetyIncident | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnQCInspection | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnDocument | app_quikconstruction | Yes | ✅ | ✅ | ✅ | — | ❌ |
| CnAuditLog | app_quikconstruction | infra | ✅ | (userId) | n/a | — | n/a |
| CnStockLedger | app_quikconstruction | infra (append-only) | ✅ | ✅ | ❌ (immutable) | — | n/a |
...
**Models missing `@@schema(...)` directive:** None. Every Cn* model declares `@@schema("app_quikconstruction")`. Only `QuikitUser` is in `auth` schema (read-only mirror of the central tenant's auth.User table).
...
### 4a. Manifest verbatim (apps/quikconstruction/app-manifest.ts)
...
export const QUIKCONSTRUCTION_MANIFEST = {
  appKey: 'quikconstruction',
  appName: 'QuikConstruction',
...
**Additional entities the AI team should ask QuikConstruction to index:**
...
The QuikConstruction app does **not currently call the AI Runtime**. There is no `INTERNAL_AI_RUNTIME_URL` env var, no `@quikit/ai-sdk` dep, no AI-related code paths. The CLAUDE.md mentions BOQ import work and approval flows but no AI features.
...
QUIKIT_CLIENT_ID            — must equal "quikconstruction" (Mode-A SSO)
...
**Everything** — there is no `.env.example` to update. This file should be authored by the QuikConstruction team and committed. Suggested contents:
```
DATABASE_URL=
DATABASE_URL_DIRECT=
NEXTAUTH_SECRET=
...
From `apps/quikconstruction/package.json`:
...
- [ ] **Drop the local `prisma/schema.prisma`** in `apps/quikconstruction/prisma/` or sync it with the canonical shared schema. The dual-schema state is confusing for any tooling that walks the repo.
...
- Drop the legacy `apps/quikconstruction/prisma/schema.prisma` once routes fully migrate to the canonical shared schema.
