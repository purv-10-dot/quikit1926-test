 ...
 * here and mint a NextAuth-compatible JWE signed with `NEXTAUTH_SECRET`, set it
 * as this app's session cookie, then redirect to the `to` claim. Cookies can't
 * be shared across distinct hosts, so this bridges the launcher's session into
 * quiksupport's own origin.
 */
