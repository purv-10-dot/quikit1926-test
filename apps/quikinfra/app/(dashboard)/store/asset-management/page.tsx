...
function AssetRegisterTab() {
  ...
  const remove = useMutation({
    ...
    meta: { successMessage: "Asset deleted", errorMessage: "Failed to delete asset" },
  });
...
function RegisterAssetDrawer({
  ...
  const create = useMutation({
    ...
    meta: { successMessage: "Asset created", errorMessage: "Failed to create asset" },
  });
...
function IssuanceTab() {
  ...
  const markReturned = useMutation({
    ...
    meta: { successMessage: "Marked as returned", errorMessage: "Failed to mark as returned" },
  });
...
function IssueAssetDrawer({
  ...
  const create = useMutation({
    ...
    meta: { successMessage: "Asset issued", errorMessage: "Failed to issue asset" },
  });
