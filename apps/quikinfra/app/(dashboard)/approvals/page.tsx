...
import { CheckCircle2, ArrowRight, Inbox, Eye } from "lucide-react";
...
interface InboxItem {
   ...
   * current step. When false the row is read-only ("Watching") — the
   * server still 403s if the caller tries to act, but the chip surfaces
   * this without making them click through to find out.
   */
  canAct?: boolean;
}
            ...
            {[0, 1].map((g) => (
              ...
              >
                ...
                {[0, 1, 2].map((r) => (
                  <div
                    key={r}
                    className="flex items-center gap-4 px-5 py-4 border-t border-slate-100 first:border-t-0"
                  >
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                              ...
                              {/* canAct chip — flagged by the server. False
                                  means the caller isn't in the current
                                  step's approver pool (most often the
                                  Admin overseeing the tenant). Clicking
                                  the row still opens the detail page;
                                  the detail page's Approve button will
                                  be gated by the same server rule. */}
                              {it.canAct === false ? (
                                <span
                                  ...
                                  title="You're not an approver on this step — read-only"
                                >
                                ...
                                <span
                                  ...
                                  title="You can approve this step"
                                >
