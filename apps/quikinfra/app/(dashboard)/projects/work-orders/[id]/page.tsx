...
import { isLabourWorkType, labourLineFromWoItem } from "@/lib/projects/labour-scope";
                  ...
                  <table className="min-w-full text-sm">
                    <thead className="bg-gray-50 text-[10px] uppercase text-gray-500 tracking-wider border-b border-gray-200">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-left font-bold">Labour Name</th>
                        <th className="px-4 py-3 text-left font-bold">Labour Type</th>
                        <th className="px-4 py-3 text-right font-bold">Labour Qty</th>
                      </tr>
                    </thead>
                        ...
                        <tr key={idx} className="hover:bg-indigo-50/20 transition-colors">
                          ...
                          <td className="px-4 py-3 text-gray-700">
                            {line.labourTypes.length
                              ? line.labourTypes.map(labourTypeLabel).join(", ")
                              : "—"}
                          </td>
                          <td className="px-4 py-3 text-right tabular-nums text-gray-900">
                            {fmtQty(line.labourQty)}
                          </td>
                        </tr>
                      ))}
                    </tbody>
