...
/**
 * JobCardDrawer — right-side slide-over wrapper around `JobCardForm`. Used
 * by the maintenance list page so "+ New Job Card" opens a drawer (matching
 * the equipment log book / purchase create-drawer pattern) instead of
      ...
      <div className={RIGHT_DRAWER_FRAME}>
        <div className={`${RIGHT_DRAWER_PANEL} max-w-3xl`}>
          <div className="flex shrink-0 items-center justify-between border-b border-gray-200 px-6 py-4 sm:px-8">
            <div>
              <h2 className="text-base font-semibold text-gray-900">
                New Maintenance Job Card
              </h2>
              <p className="text-xs text-gray-500 mt-0.5">
                Machine moves to Under Maintenance until closed
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="min-h-0 flex-1">
            <JobCardForm embedded onSaved={onSaved} onCancel={onClose} />
          </div>
        </div>
      </div>
    </>
