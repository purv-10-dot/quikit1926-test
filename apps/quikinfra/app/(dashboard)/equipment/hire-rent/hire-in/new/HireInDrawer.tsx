...
/**
 * HireInDrawer — right-side slide-over wrapper around `HireInForm`, opened
 * from the Hire & Rent list page (Hire-In Verification tab).
 */
      ...
      <div className={RIGHT_DRAWER_FRAME}>
        <div className={`${RIGHT_DRAWER_PANEL} max-w-3xl`}>
          <div className="flex shrink-0 items-center justify-between border-b border-gray-200 px-6 py-4 sm:px-8">
            <div>
              <h2 className="text-base font-semibold text-gray-900">
                Hire-In Verification
              </h2>
              <p className="text-xs text-gray-500 mt-0.5">
                Logged qty (approved logs) vs vendor-claimed → variance → payable
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="min-h-0 flex-1">
            <HireInForm embedded onSaved={onSaved} onCancel={onClose} />
          </div>
        </div>
      </div>
    </>
