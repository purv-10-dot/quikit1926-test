 ...
 * Each module gets ported in sequence (see docs/engineering/QUIKINFRA_MIGRATION.md).
 */
  ...
  return (
    <div className="p-8 max-w-2xl">
      ...
      <p className="text-sm text-gray-600">
        ...
        <code className="bg-gray-100 px-1 rounded text-xs">docs/engineering/QUIKINFRA_MIGRATION.md</code>{" "}
        for the porting schedule. Standalone QuikInfra (port 3010) still
