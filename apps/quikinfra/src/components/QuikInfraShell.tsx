...
const CONSTRUCTION_NAV: NavItem[] = [
  ...
  { label: "MACHINERY & EQUIPMENT", isSection: true },
  {
    ...
    featureKey: "machineryEquipment",
    children: [
      { label: "Equipment Log Book", href: "/equipment/log-book", iconComponent: Gauge, requiredPermission: "equipment.log.read", featureKey: "machineryEquipment.logBook" },
      { label: "Maintenance", href: "/equipment/maintenance", iconComponent: Wrench, requiredPermission: "equipment.maintenance.read", featureKey: "machineryEquipment.maintenance" },
      { label: "Deployment & Compliance", href: "/equipment/deployment", iconComponent: Truck, requiredPermission: "equipment.deployment.read", featureKey: "machineryEquipment.deployment" },
      { label: "Fleet Dashboard", href: "/equipment/fleet", iconComponent: BarChart3, requiredPermission: "equipment.fleet.read", featureKey: "machineryEquipment.fleet" },
      { label: "Hire & Rent", href: "/equipment/hire-rent", iconComponent: ArrowLeftRight, requiredPermission: "equipment.hire_rent.read", featureKey: "machineryEquipment.hireRent" },
      { label: "Fixed Asset / Tools", href: "/equipment/fixed-assets", iconComponent: Boxes, requiredPermission: "equipment.fixed_assets.read", featureKey: "machineryEquipment.fixedAssets" },
    ],
  },
