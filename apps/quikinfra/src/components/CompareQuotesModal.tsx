...
import { Crown, GitCompare, Mail, Trophy, X } from "lucide-react";
...
interface Props {
  ...
  onCreatePO?: (vendorRowId: string) => void;
}
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[92vh] flex flex-col overflow-hidden">
        {/* Header */}
        <div className="flex items-start justify-between gap-4 px-6 pt-5 pb-4 border-b border-gray-100 shrink-0 bg-gradient-to-b from-indigo-50/40 to-white">
