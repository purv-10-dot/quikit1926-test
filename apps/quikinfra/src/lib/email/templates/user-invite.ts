/**
 * User invitation email template — QuikInfra.
 *
...
export function buildUserInviteEmail(input: UserInviteTemplateInput): {
  ...
  const subject = `You're invited to QuikInfra`;
          ...
          <tr>
            <td style="padding:18px 44px 6px 44px;">
              <p style="margin:0;font-size:14px;line-height:22px;color:#cbd5e1;text-align:center;">
                ...
                <strong style="color:#ffffff;">${escapeHtml(input.invitedByName ?? "QuikInfra")}</strong>
                on <strong style="color:#ffffff;">QuikInfra</strong>.
                ${
                  input.loginEmail
          ...
          <tr>
            <td style="padding:18px 44px 0 44px;">
              <p style="margin:0;font-size:14px;line-height:22px;color:#cbd5e1;text-align:center;">
                ...
                orders — QuikInfra has your back.
              </p>
            </td>
          </tr>
                     ...
                     <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0f172a;border:1px dashed #475569;border-radius:12px;">
                       ...
                       <tr>
                         ...
                         <td style="padding:14px 18px;text-align:right;border-top:1px dashed #475569;white-space:nowrap;">
                           <!-- Email clients (Gmail/Outlook) block clipboard JS, so we render
                                the password in a readonly input the recipient can select with
                                a click and copy via Ctrl/Cmd+C. The tip line below the table
                                spells out the mechanic. -->
                           <input
                             readonly
                             value="${escapeAttr(input.tempPassword)}"
                             style="width:150px;max-width:200px;text-align:center;cursor:text;font-family:ui-monospace,Menlo,monospace;font-size:14px;color:#fbbf24;font-weight:700;padding:6px 10px;border-radius:6px;border:1px solid rgba(251,191,36,.25);background:rgba(251,191,36,.08);outline:none;"
                           />
                         </td>
                       </tr>
                     </table>
                     <p style="margin:10px 0 0 0;font-size:11px;color:#94a3b8;text-align:center;">
                       Tip: click the password to select, then press <strong style="color:#cbd5e1;">Ctrl+C</strong> to copy. Change this password on your first login for security.
                     </p>
                   </td>
                 </tr>`
              : ""
