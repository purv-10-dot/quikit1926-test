...
**QuikInfra** — Next.js 14 App Router construction ERP. Multi-tenant (PostgreSQL via Prisma), NextAuth for sessions, role-based permissions, approval workflow engine. Excel BOQ import → project execution (DPR/RAB) → stock + procurement.
