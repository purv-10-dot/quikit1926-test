# QuikInfra — Final Closure Audit (Session 6)
...
### QA test harness
```
$ DATABASE_URL=… node scripts/qa-test-quikinfra.mjs
...
### Docker
```
$ docker build --target deps -f apps/quikinfra/Dockerfile .
