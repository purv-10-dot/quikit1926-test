#!/usr/bin/env node
/**
 * QA integration + formula verification for QuikConstruction.
 *
 * Reads data seeded by:
 *   - seed-quikconstruction.mjs
 *   - seed-quikconstruction-procurement.mjs
 *   - seed-quikconstruction-full.mjs
 *
...
async function main() {
  console.log("=== QuikConstruction QA Audit ===\n");
