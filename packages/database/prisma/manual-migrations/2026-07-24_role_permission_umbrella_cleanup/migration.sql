...
--    environment:
--      1. The Phase 3 migration was run (per-page rows exist) — see
--         2026-07-24_role_permission_per_page_split.
...
--    This is why it MUST stay a separate step from Phase 3 — a code deploy sits
--    between the two.
--
