...
//   quikfinance → 3013   quiklms → 3014   quikcredflow → 3076
...
const QUIKCREDFLOW_BASE = resolveAppUrl("QUIKCREDFLOW_URL", "http://localhost:3076"); // prod-safety-allow: dev fallback, prod throws via resolveAppUrl
...
const APPS = [
  ...
  },
  {
    slug: "quikcredflow",
    name: "QuikCredFlow",
    description: "QuikCredFlow CRM — leads, pipeline, telephony, disposition, automation.",
    baseUrl: QUIKCREDFLOW_BASE,
    iconUrl: `${QUIKIT_BASE}/app-icons/quikcrm.svg`,
    status: "active",
    oauth: {
      clientId: "quikcredflow",
      clientSecretPlain: resolveClientSecret("QUIKCREDFLOW_OAUTH_CLIENT_SECRET", "credflow-dev-secret-change-in-prod"),
      redirectUris: [
        `${QUIKCREDFLOW_BASE}/api/auth/callback/quikit`,
      ],
      scopes: ["openid", "profile", "email", "tenant"],
    },
  },
